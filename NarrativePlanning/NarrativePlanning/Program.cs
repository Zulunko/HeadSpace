...
namespace NarrativePlanning
{
    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            ////////////////////////////////////////////////////////
            DomainBuilder.JSONDomainBuilder j = new NarrativePlanning.DomainBuilder.JSONDomainBuilder("../../JSON Files/mpk_eval_task_initialknowledge.json", new Preferences());
            ...
            UnityConsole.Log("Stop", LOGMODE.WORLDSTATE);*/
             ...
             NarrativePlanning.PlanningProblem problem = new NarrativePlanning.PlanningProblem(j.initial, j.goal, j.operators, new Preferences(), j.initialKnowledge);
